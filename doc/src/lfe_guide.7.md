...
(define-module name doc-string declaration ... )
(extend-module doc-string declaration ... )

(define-function name doc-string lambda|match-lambda)
(define-macro name doc-string lambda|match-lambda)
```
